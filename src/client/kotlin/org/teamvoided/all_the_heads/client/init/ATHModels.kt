...
object ATHModels {
    ...
    val BREEZE_HEAD = mainLayer("breeze_head")
    ...
    val ENDERMAN_HEAD = mainLayer("enderman_head")
    ...
    val GHAST_HEAD = mainLayer("ghast_head")
    ...
    val SNOW_GOLEM_HEAD = mainLayer("snow_golem_head")
    val SPIDER_HEAD = mainLayer("spider_head")
    val SQUID_HEAD = mainLayer("squid_head")
    ...
    fun init() {
        ...
        register(BreezeHeadModel.ID, BREEZE_HEAD, BreezeHeadModel::head, ::BreezeHeadModel)
        ...
        register(EndermanHeadModel.ID, ENDERMAN_HEAD, EndermanHeadModel::head, ::EndermanHeadModel)
        ...
        register(GhastHeadModel.ID, GHAST_HEAD, GhastHeadModel::head, ::GhastHeadModel)
        ...
        register(SnowGolemHeadModel.ID, SNOW_GOLEM_HEAD, SnowGolemHeadModel::head, ::SnowGolemHeadModel)
        register(SpiderHeadModel.ID, SPIDER_HEAD, SpiderHeadModel::head, ::SpiderHeadModel)
        register(SquidHeadModel.ID, SQUID_HEAD, SquidHeadModel::head, ::SquidHeadModel)
